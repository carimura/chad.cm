...
*Originally posted [here](https://medium.com/@carimura/thanks-and-onward-ed79068413de).*

<div class="main-image" style="text-align: center;">
<img src="/assets/posts/thanks-and-onward.png" alt="Thanks and Onward" style="max-width: 100%;">
<p style="font-size: 0.8em; color: gray; margin: 5px 0 0 0;">SimpleWorker from 2010</p>
</div>
...
It's been amazing to watch serverless really take shape. Who would have thought building a [serverless search engine](https://blog.iron.io/how-to-build-serverless-search-engine/) and [the future is serverless](https://readwrite.com/why-the-future-of-software-and-apps-is-serverless/) from 6 years ago would foreshadow an entire category of computing? I still remember talking about tasks as the atomic unit of compute (most people saying Functions now), and small units of LXC-containerized jobs being an essential pattern of the future (Docker now). Now there are serverless conferences, serverless podcasts, serverless analysts, and even emerging serverless standards. Where did all the servers go?
...
Find me on [LinkedIn](https://www.linkedin.com/in/chadarimura/), [Twitter](https://x.com/chadarimura), this blog, and email to stay in touch.
